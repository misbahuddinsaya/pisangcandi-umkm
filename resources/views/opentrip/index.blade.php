    ...
    <div class="container">
        <div class="row gy-4">
            ...
            <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
                <a href="{{ route('opentrip.detail') }}" class="card-link">
                    <div class="card service-card">
                        <img src="{{ asset('assets/img/opentrip-img/Kawah Ijen.png') }}" class="card-img-top" alt="...">
                        <div class="card-body">
                            <h5 class="card-title">Explore Kawah Ijen Jawa Timur</h5>
                            <p class="card-text">
